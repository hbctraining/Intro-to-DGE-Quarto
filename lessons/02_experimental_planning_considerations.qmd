...
description: |
  This lesson explores the crucial factors involved in the experimental design of RNA-seq differential expression studies. Participants will examine the importance of replicates, sequencing depth, avoidance of confounding factors and batch effect management in planning robust, reproducible experiments. The lesson provides guidance on the types and recommended numbers of replicates, how to balance sequencing depth and biological variability, strategies for preventing confounding and best practices for identifying and accounting for batch effects in experimental and analytical workflows. Participants will develop the skills to design thoughtful, high-quality RNA-seq experiments that yield reliable results for downstream analysis.
author:
  - Meeta Mistry
  - Radhika Khetani
  - Mary Piper
...
*Image credit: [Klaus B, 2015](https://dx.doi.org/10.15252%2Fembj.201592958)*
...
*Image credit: [Liu Y et al., 2014](https://doi.org/10.1093/bioinformatics/btt688)*
...
*Image credit: [Hicks SC et al., 2015](https://www.biorxiv.org/content/early/2015/08/25/025528)*

The issues generated by poor batch study design are highlighted nicely in [Gilad Y & Mizrahi-Man O, 2015](https://f1000research.com/articles/4-121/v1).
...
::: callout-tip
# [**Exercise 1**](02_experimental_planning_considerations-Answer_key.qmd#exercise-1)
...
[Next Lesson](03_DGE_setup_and_overview.qmd)
