...
description: |
  This lesson introduces the statistical properties of RNA-seq count data and explores appropriate statistical models for their analysis. Participants will visualize raw count distributions, understand why RNA-seq data differ from normally distributed data and compare the suitability of binomial, Poisson and negative binomial models. The lesson emphasizes the importance of biological replicates in estimating variance, detecting differential expression and minimizing false positives. By the end of this session, participants will understand why the negative binomial model is typically used for RNA-seq analysis and how tools like DESeq2 apply these concepts.
author:
  - Meeta Mistry
  - Radhika Khetani
  - Mary Piper
...
```{r}
#| label: mean_vs_variance_calculate
...
::: callout-tip
# [**Exercise 1**](04_RNAseq_count_distribution-Answer_key.qmd#exercise-1)
...
::: callout-tip
# [**Exercise 2**](04_RNAseq_count_distribution_Answers.html#exercise-2)
...
[Next Lesson](05_DGE_count_normalization.qmd)
