...
::: callout-note
Need help figuring out **what information should be present in your metadata?** We have [additional materials](experimental_planning_considerations.html) highlighting bulk RNA-seq planning considerations. Please take a look at these materials before starting an experiment to help with proper experimental design.
:::
...
First we create a DESeqDataSet as we did in the ['Count normalization'](02_DGE_count_normalization.html#create-deseq2-object) lesson and specify the `txi` object which contains our raw counts, the metadata variable, and provide our design formula:
