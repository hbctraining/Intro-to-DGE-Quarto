...
To better understand how it works, **please go through [this YouTube video from StatQuest](https://www.youtube.com/watch?v=_UVHneBUBW0) that explains PCA**. Alternatively, we have **prepared a [PCA lesson](Aside_principal_component_analysis.html)**. After you have gone through the material, please proceed with the interpretation section below.
...
::: callout-tip
# [**Exercise 1**](06_DGE_QC_analysis-Answer_key.qmd#exercise-1)
...
[Next Lesson](07_design_formulas.qmd)
