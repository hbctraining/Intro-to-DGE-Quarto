...
<p align="center">
<img src="../img/Combined_PCA_heatmap_example.png" width="700">
</p>
...
**In the plot below, we would be quite concerned about samples not clustering with the other replicates. We would want to explore the PCA to see if we see the same clustering of samples.**
