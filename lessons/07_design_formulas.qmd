...
description: |
  This lesson explains the importance and implementation of design formulas in DESeq2 for differential expression analysis of RNA-seq data. Participants will understand how to specify simple and complex experimental designs, including multiple covariates and interaction terms, within the DESeq2 framework. Guidance demonstrating the best practices for constructing design formulas and running the full DESeq2 analysis pipeline, ensuring accurate detection of differentially expressed genes while accounting for sources of variation inherent in experimental data.
author:
  - Meeta Mistry
  - Radhika Khetani
  - Mary Piper
...
::: callout-tip
# [**Exercise 1**](07_design_formulas-Answer_key.html#exercise-1)
...
::: callout-note
Need help figuring out **what information should be present in your metadata?** We have [additional materials](02_experimental_planning_considerations.html) highlighting bulk RNA-seq planning considerations. Please take a look at these materials before starting an experiment to help with proper experimental design.
:::
...
First we create a DESeqDataSet as we did in the ['Count normalization'](05_DGE_count_normalization.html#create-deseq2-object) lesson and specify the `txi` object that contains our raw counts, the metadata variable, and provide our design formula:
...
::: callout-tip
# [**Exercise 2**](07_design_formulas-Answer_key.html#exercise-2)
...
[Next Lesson](08_hypothesis_testing.qmd)
