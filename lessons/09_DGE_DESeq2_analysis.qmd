...
To normalize the count data, DESeq2 calculates size factors for each sample using the *median of ratios method* discussed previously in the ['Count normalization'](05_DGE_count_normalization.html) lesson. 
...
::: callout-tip
# [**Exercise 1**](09_DGE_DESeq2_analysis-Answer_key.qmd#exercise-1)
...
[Next Lesson](10_wald_test_results.qmd)
