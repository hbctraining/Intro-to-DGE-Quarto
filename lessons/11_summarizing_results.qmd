...
```{r}
#| label: results_sig_render
#| echo: false
# Take a quick look at our top significant genes
sigOE %>% head() %>% DT::datatable()
```

::: callout-tip
# [**Exercise 1**](11_summarizing_results-Answer_key.qmd#exercise-1)
...
[Next Lesson](12_DGE_visualizing_results.qmd)
