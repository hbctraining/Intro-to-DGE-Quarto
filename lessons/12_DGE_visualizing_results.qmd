...
As discussed in the [Set up lesson](03_DGE_setup_and_overview.html#review-of-the-dataset), knockdown of Mov10 was achieved using siRNA. RNA interference is inefficient: some RNAs escape degradation, and thus some expression remains.
:::

```{r plot_one_gene_ggplot}
...
If you are interested in plotting the expression of multiple genes all together, please refer to [the short lesson linked here](Aside_top20_genes-expression_plotting.html) where we demo this for the top 20 most significantly expressed genes.
:::
