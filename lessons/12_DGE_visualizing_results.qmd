...
As discussed in the [Set up lesson](03_DGE_setup_and_overview.html), knockdown of Mov10 was achieved using siRNA. RNA interference is inefficient: some RNAs escape degradation, and thus some expression remains.
:::
