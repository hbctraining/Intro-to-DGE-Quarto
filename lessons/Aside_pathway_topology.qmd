...
# Look at the results (prevent "KEGGLINK" column from wrapping so the table is not incredibly long)
spia_result %>% head(n = 20) %>% DT::datatable() %>% DT::formatStyle("KEGGLINK", "white-space" = "nowrap")
```
