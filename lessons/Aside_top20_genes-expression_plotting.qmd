...
description: |
  This lesson will demonstrate how to visualize the expression of multiple top-ranked genes. Participants will practice data wrangling with `tidyverse` tools to prepare count data for plotting, merge with sample metadata and create informative visualization highlighting sample groups and gene expression patterns.
author:
  - Meeta Mistry
  - Radhika Khetani
  - Mary Piper
