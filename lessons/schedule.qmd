...
| 11:00 - 11:45 | [Intro to DGE / setting up DGE analysis](./03_DGE_setup_and_overview.html) | Meeta |
...
1. Please **study the contents** and **work through all the code** within the following lessons:
  ...
  * [RNA-seq counts distribution](./04_RNAseq_count_distribution.html)
...
:::
  ...
  * [Count normalization](./05_DGE_count_normalization.html)
...
:::
  ...
  * [Sample-level QC](./06_DGE_QC_analysis.html) (PCA and hierarchical clustering)
...
| 11:00 - 11:30 | [Design formulas](./07_design_formulas.html)                                    | Will |
| 11:30 - 12:00 | [Hypothesis testing and multiple test correction](./08_hypothesis_testing.html) | Meeta |

### Before the next class:

1. Please **study the contents** and **work through all the code** within the following lessons:

  * [Description of steps for DESeq2](./09_DGE_DESeq2_analysis.html)
...
:::
  ...
  * [Wald test results](./10_wald_test_results.html)
 ...
 * [Summarizing results and extracting significant gene lists](./11_summarizing_results.html)
...
:::
  ...
  * [Visualization](./12_DGE_visualizing_results.html)
...
| 11:15 - 12:00 | [Likelihood Ratio Test results](./13_DGE_LRT_results.html) | Meeta |

### Before the next class:

1. Please **study the contents** and **work through all the code** within the following lessons:

  * [Time course analysis](./14_time_course_analyses.html)
...
:::
  ...
  * [Gene annotation](./15_genomic_annotation.html)
...
:::
  ...
  * [Functional analysis - over-representation analysis](./16_FA_over-representation_analysis.html)
...
:::
  ...
  * [Functional analysis - functional class scoring / GSEA](./17_FA_functional_class_scoring.html)
...
| 11:00 - 11:15 | [Summarizing workflow](./18_DGE_summarizing_workflow.html) | Will |
