...
| 11:00 - 11:45 | [Intro to DGE / setting up DGE analysis](../lessons/03_DGE_setup_and_overview.html) | Meeta |
...
1. Please **study the contents** and **work through all the code** within the following lessons:
  ...
  * [RNA-seq counts distribution](../lessons/04_RNAseq_count_distribution.html)
...
:::
  ...
  * [Count normalization](../lessons/05_DGE_count_normalization.html)
...
:::
  ...
  * [Sample-level QC](../lessons/06_DGE_QC_analysis.html) (PCA and hierarchical clustering)
...
| 11:00 - 11:30 | [Design formulas](../lessons/07_design_formulas.html)                                    | Will |
| 11:30 - 12:00 | [Hypothesis testing and multiple test correction](../lessons/08_hypothesis_testing.html) | Meeta |

### Before the next class:

1. Please **study the contents** and **work through all the code** within the following lessons:

  * [Description of steps for DESeq2](../lessons/09_DGE_DESeq2_analysis.html)
...
:::
  ...
  * [Wald test results](../lessons/10_wald_test_results.html)
 ...
 * [Summarizing results and extracting significant gene lists](../lessons/11_summarizing_results.html)
...
:::
  ...
  * [Visualization](../lessons/12_DGE_visualizing_results.html)
...
| 11:15 - 12:00 | [Likelihood Ratio Test results](../lessons/13_DGE_LRT_results.html) | Meeta |

### Before the next class:

1. Please **study the contents** and **work through all the code** within the following lessons:

  * [Time course analysis](../lessons/14_time_course_analyses.html)
...
:::
  ...
  * [Gene annotation](../lessons/15_genomic_annotation.html)
...
:::
  ...
  * [Functional analysis - over-representation analysis](../lessons/16_FA_over-representation_analysis.html)
...
:::
  ...
  * [Functional analysis - functional class scoring / GSEA](../lessons/17_FA_functional_class_scoring.html)
...
| 11:00 - 11:15 | [Summarizing workflow](../lessons/18_DGE_summarizing_workflow.html) | Will |
